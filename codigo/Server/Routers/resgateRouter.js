...
router.post('/', async (req, res) => {
    ...
    try {
        const queryResult = await connection.query('INSERT INTO resgate (aluno, vantagem, data, valor, cupom) VALUES ($1, $2, $3, $4, $5) RETURNING id', [aluno, vantagem, data, valor, cupom]);
        res.json(queryResult.rows[0].id);
    } catch (e) {
        console.error(e);
...
router.get('/get-vantagem/:id', async (req, res) => {
    const { id } = req.params
